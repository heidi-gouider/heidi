        ...
        <div class="container mt-50">
            <div class="row">
                <div class="col-md-12 mt-5 mb-5">
                    <h2 class="text-white text-center mb-5">Politique de confidentialité </h2>
                    <div class="text-white" style="background-color: rgba(0, 0, 0, 0.6);">
                        ...
                        <p>
                            ...
                            En utilisant les services de The District, vous consentez à ce qu’e-Resto utilise vos données personnelles
                            de la manière décrite dans la présente Politique de Confidentialité.
                        </p>
                        <p>
                            Soyez assuré qu’e-Resto s’est engagé à collecter et utiliser vos données personnelles de manière responsable,
                            sécurisée et en toute transparence. Si vous avez le moindre doute, ou une question, contactez-nous à alex@e-resto.fr.
                        </p>
                        <h3 class="mb-5 mt-3 text-decoration-underline" style="font-size: 28px;">
                        ...
                        <p>
                            Nous nous assurons toujours d’avoir mis en place la sécurité maximale, et le cas échéant les garanties contractuelles appropriées
                            pour protéger vos données personnelles avant de les partager. Nous pouvons partager vos données personnelles avec les destinataires suivants :
                        </p>
                        <ul>
                            <li>
                        ...
                        <p>
                            Chez e-Resto, nous accordons une grande importance à la sécurité et la protection de vos données personnelles,
                            notamment contre tout accès non autorisé, tout traitement illégal, destruction, perte. Notre équipe technique met en oeuvre des mesures afin de garantir la sécurité de vos informations.
                        </p>
                        <h3 class="mb-5 mt-3 text-decoration-underline" style="font-size: 28px;">
                        ...
                        <p>
                            ...
                            Par exemple, toute la période durant laquelle votre Restaurant est référencé et présent sur notre plateforme. Dans le cadre de la tenue de nos dossiers,
                            et le respect de nos obligations légales, nous pouvons être à-même de conserver certains éléments de vos données personnelles pour une période ultérieure à votre désactivation et suppression de compte.
                        </p>
                        <h3 class="mb-5 mt-3 text-decoration-underline" style="font-size: 28px;">
                        ...
                        <p>
                            Pour toute question, demande d’informations supplémentaires, ou préoccupation concernant notre Politique de Confidentialité ou nos services, vous pouvez nous contacter sur : heidi@the.district.fr.
                        </p>
                    </div>
                </div>
            </div>
